...
fn paint_cloud_layer_small_horizon_no_op() {
    ...
    paint_cloud_layer(&mut canvas, 50.0, 10.0, seed("small"), 0.0, 3, 40);
}
...
fn paint_cloud_layer_high_coverage_covers_more_of_canvas() {
    ...
    paint_cloud_layer(&mut light_canvas, 30.0, 5.0, seed("light"), 0.0, 12, 60);
    paint_cloud_layer(&mut heavy_canvas, 90.0, 5.0, seed("heavy"), 0.0, 12, 60);
...
fn paint_cloud_layer_medium_coverage_exercises_50_branch() {
    ...
    paint_cloud_layer(&mut canvas, 65.0, 8.0, seed("medium"), 1.0, 14, 60);
}
...
fn paint_cloud_layer_very_high_coverage_exercises_70_branch() {
    ...
    paint_cloud_layer(&mut canvas, 75.0, 8.0, seed("very-high"), 1.0, 14, 60);
}
